...
describe("getYieldForPlant", () => {
    test("yield plant without influencingFactors", () => {
        expect(getYieldForPlant(corn)).toBe(30);
    });
});

describe("Yield Plant with influencingFactors", () => {
    test("corn, sun:low", () => {
...
describe("getYieldForCrop with influencingFactors", () => {
...
describe("getTotalYield", () => {
    test("Calculate total yield crops", () => {
        const crops = [
...
describe("tTotalProfit with env. factors", () => {
